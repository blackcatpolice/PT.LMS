...
namespace Pagetechs.Framework.Wx.Pay.WxPayAPI
{
    ...
    public class NativeNotify : Notify
    {
        ...
        public string ProcessNotify(Stream InputStream, string notifyUrl)
        {
            ...
            //调统一下单接口，获得下单结果
            return ProcessNotify(notifyData, notifyUrl);
            //page.Response.Write(data.ToXml());
            //page.Response.End();
        }

        public string ProcessNotify(WxPayData notifyData, string notifyUrl)
        {
            ...
            try
            {
                unifiedOrderResult = UnifiedOrder(openid, product_id, notifyUrl);
            }
        ...
        private WxPayData UnifiedOrder(string openId, string productId, string notifyUrl)
        {
            //统一下单
            ...
            WxPayData result = WxPayApi.UnifiedOrder(req, notifyUrl);
            return result;
        }
    }
}